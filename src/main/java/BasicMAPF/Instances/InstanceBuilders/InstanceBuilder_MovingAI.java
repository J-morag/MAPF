    ...
    private GraphMap getMap( InstanceManager.InstancePath instancePath, InstanceProperties instanceProperties ){
        ...
        while ( nextLine != null ){
            ...
            if(nextLine.startsWith(INDICATOR_HEIGHT)){
                ...
                // build map
                graphMap = I_InstanceBuilder.buildGraphMap(mapAsStrings, SEPARATOR_MAP, dimensionsFromFile, locationTypeHashMap, instanceProperties.obstacles, ASSUME_STRONGLY_CONNECTED);
                break;
            }
