...
public class PIBT_ForLaCAM extends A_Solver {
     ...
     * constructor.
     */
    public PIBT_ForLaCAM(I_SolutionCostFunction solutionCostFunction, Integer RHCR_Horizon, Boolean returnPartialSolutions, Integer finalTimeStamp) {
        super.name = "PIBT_ForLaCAM";
