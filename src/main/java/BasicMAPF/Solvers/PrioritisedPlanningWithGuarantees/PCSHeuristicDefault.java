...
public class PCSHeuristicDefault implements I_PCSHeuristic {
    @Override
    public int[] getH(Agent[] priorityOrderedAgents, int numMDDsAlreadyInNode, @NotNull I_ConstraintSet constraints, MAPF_Instance currentInstance, SingleAgentGAndH singleAgentHeuristic) {
