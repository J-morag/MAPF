...
//        solvers.add(LifelongSolversFactory.LH1_Approach30ASFP_Cap18_Timeout1p5()); // greedy +IS +Avoid-20-ASFP + 18 capacity + dynamic timeout 1.5
        ...
        solvers.add(LifelongSolversFactory.PIBT_AllAgents_LH1_Go5ASFP());
        solvers.add(LifelongSolversFactory.PrP_AllAgents_LH1_Go5ASFP());
        solvers.add(LifelongSolversFactory.PrP_LH1_Go5ASFP_Cap18_Timeout1p5());
