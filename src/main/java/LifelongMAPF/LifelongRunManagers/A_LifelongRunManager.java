...
//        solvers.add(LifelongSolversFactory.allAgentsPrPDeepPartialRHCR_w10_h03()); // baseline and friends experiment
        ...
        solvers.add(LifelongSolversFactory.stationaryAgentsPrPDeepPartialAllStayFPRHCR_w10_h03Lookahead2()); // micro experiment
        solvers.add(LifelongSolversFactory.stationaryAgentsPrPDeepPartialStayOnceFPRHCR_w10_h03Lookahead2()); // micro experiment
        solvers.add(LifelongSolversFactory.stationaryAgentsPrPDeepPartialOneActionFPRHCR_w10_h03Lookahead2()); // baseline and friends experiment // lookaheads experiment // comparing macro FPs experiment // micro experiment
//
...
//        solvers.add(LifelongSolversFactory.stationaryAgentsPrPDeepPartialOneActionFPRHCR_w10_h03Lookahead4()); // lookaheads experiment
        solvers.add(LifelongSolversFactory.stationaryAgentsPrPDeepPartialOneActionFPRHCR_w10_h03Lookahead5()); // lookaheads experiment
...
//        solvers.add(LifelongSolversFactory.stationaryAgentsPrPDeepPartialOneActionFPLookahead1()); // greedy
