...
//        solvers.add(LifelongSolversFactory.LH_1PPRIGo_20ASFPCapacity_1()); // greedy +IA +IGo-20-ASFP + 1 capacity
//        solvers.add(LifelongSolversFactory.LH_1PPRIGo_20ASFPCapacity_3()); // greedy +IA +IGo-20-ASFP + 3 capacity
        solvers.add(LifelongSolversFactory.LH_1PPRIGo_20ASFPCapacity_6()); // greedy +IA +IGo-20-ASFP + 6 capacity
        solvers.add(LifelongSolversFactory.LH_1PPRIGo_20ASFPCapacity_6RHCR_w10_h3()); // greedy +IA +IGo-20-ASFP + 6 capacity +RHCR_w10_h3
