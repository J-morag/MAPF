...
//        solvers.add(LifelongSolversFactory.LH_1PPRIGo_10ASFPCapacity_18()); // greedy +IS +IGo-10-ASFP + 18 capacity
//        solvers.add(LifelongSolversFactory.LH_1PPRIGo_10ASFPCapacity_18DynamicTimeout0p75()); // greedy +IS +IGo-10-ASFP + 18 capacity + dynamic timeout 0.75
//        solvers.add(LifelongSolversFactory.LH_1PPRIGo_10ASFPCapacity_18DynamicTimeout1p0()); // greedy +IS +IGo-10-ASFP + 18 capacity + dynamic timeout 1.0
//        solvers.add(LifelongSolversFactory.LH_1PPRIGo_10ASFPCapacity_18DynamicTimeout1p25()); // greedy +IS +IGo-10-ASFP + 18 capacity + dynamic timeout 1.25
//        solvers.add(LifelongSolversFactory.LH_1PPRIGo_10ASFPCapacity_18DynamicTimeout1p5()); // greedy +IS +IGo-10-ASFP + 18 capacity + dynamic timeout 1.5
//        solvers.add(LifelongSolversFactory.LH_1PPRIGo_10ASFPCapacity_18DynamicTimeout1p75()); // greedy +IS +IGo-10-ASFP + 18 capacity + dynamic timeout 1.75
//        solvers.add(LifelongSolversFactory.LH_1PPRIGo_10ASFPCapacity_18DynamicTimeout2p0()); // greedy +IS +IGo-10-ASFP + 18 capacity + dynamic timeout 2.0
