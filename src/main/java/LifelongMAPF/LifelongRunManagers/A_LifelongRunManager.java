...
public abstract class A_LifelongRunManager extends A_RunManager {
    ...
    public static Collection<? extends I_Solver> getSolvers() {
        ...
        solvers.add(LifelongSolversFactory.stationaryAgentsPrPNoPartialRHCR_w10_h03Lookahead2()); // micro experiment
...
//        solvers.add(LifelongSolversFactory.allAgentsPrPDeepPartialRHCR_w10_h03()); // baseline and friends experiment
        ...
        solvers.add(LifelongSolversFactory.stationaryAgentsPrPDeepPartialRHCR_w10_h03Lookahead2()); // micro experiment
