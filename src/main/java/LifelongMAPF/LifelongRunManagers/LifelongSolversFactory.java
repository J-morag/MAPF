...
public class LifelongSolversFactory {
    ...
    public static I_Solver PrP_LH1_Go5ASFP_Cap18_Timeout1p5(){
        int replanningPeriod = 1;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = null;
        int targetsCapacity = 18;
    ...
    public static I_Solver PrP_AllAgents_LH1_Go5ASFP(){
        int replanningPeriod = 1;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = null;
        int targetsCapacity = 18;
    ...
    public static I_Solver PIBT_AllAgents_LH1_Go5ASFP(){
        int replanningPeriod = 1;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = null;
        int targetsCapacity = 18;
