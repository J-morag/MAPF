...
public class LifelongSolversFactory {
    ...
    public static I_Solver stationaryAgentsReplanSinglePartialAllowedClassic(){
        A_Solver solver = new LifelongSimulationSolver(null, new StationaryAgentsSubsetSelector(),
                new PrioritisedPlanning_Solver(null, null, null, new RestartsStrategy(RestartsStrategy.reorderingStrategy.none, 1, RestartsStrategy.reorderingStrategy.none, null), 
    ...
    public static I_Solver stationaryAgentsPrPPartialAllowedRHCR5(){
        A_Solver solver = new LifelongSimulationSolver(null, new StationaryAgentsSubsetSelector(),
                new PrioritisedPlanning_Solver(null, null, null, new RestartsStrategy(RestartsStrategy.reorderingStrategy.randomRestarts, 101, RestartsStrategy.reorderingStrategy.randomRestarts, null),
    ...
    public static I_Solver simpleLNS_infHorizon(){
        int replanningPeriod = 3;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
//        Integer RHCRHorizon = null;
//        I_AStarFailPolicy asfpf = new GoASFP(5);
...
//        prp.aStarTimeAllocationFactor = 1.5f;
    ...
    public static I_Solver simplePrP_infHorizon(){
        int replanningPeriod = 3;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
//        Integer RHCRHorizon = null;
//        I_AStarFailPolicy asfpf = new GoASFP(5);
        PrioritisedPlanning_Solver prp = new PrioritisedPlanning_Solver(new SingleAgentAStar_Solver(), null, null,
                new RestartsStrategy(RestartsStrategy.reorderingStrategy.randomRestarts, 1000, RestartsStrategy.reorderingStrategy.randomRestarts, null),
//                new RestartsStrategy(RestartsStrategy.reorderingStrategy.none, 0, RestartsStrategy.reorderingStrategy.randomRestarts, null),
...
//        prp.aStarTimeAllocationFactor = 1.5f;
    ...
    public static I_Solver simplePrP_plusTransient(){
        int replanningPeriod = 3;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        PrioritisedPlanning_Solver prp = new PrioritisedPlanning_Solver(new SingleAgentAStar_Solver(), null, new SumServiceTimes(),
                new RestartsStrategy(RestartsStrategy.reorderingStrategy.randomRestarts, 1000, RestartsStrategy.reorderingStrategy.randomRestarts, null),
                false, false, TransientMAPFSettings.defaultTransientMAPF, null, null);
...
//    LNSBuilder = new
    ...
    public static I_Solver LNSt_SubSetSelector(){
        int replanningPeriod = 3;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = null;
        int targetsCapacity = 18;
        I_AStarFailPolicy asfpf = new GoASFP(5);
        LargeNeighborhoodSearch_Solver lns = new LNSBuilder().setTransientMAPFBehaviour(TransientMAPFSettings.defaultTransientMAPF).setSolutionCostFunction(new SumServiceTimes()).createLNS();
        A_Solver solver = new LifelongSimulationSolver(null, new StationaryAgentsSubsetSelector(new PeriodicSelector(replanningPeriod)),
    ...
    public static I_Solver LNS_SubSetSelector(){
        int replanningPeriod = 3;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = null;
        int targetsCapacity = 18;
        I_AStarFailPolicy asfpf = new GoASFP(5);
        LargeNeighborhoodSearch_Solver lns = new LNSBuilder().setSharedGoals(true).createLNS();
        A_Solver solver = new LifelongSimulationSolver(null, new StationaryAgentsSubsetSelector(new PeriodicSelector(replanningPeriod)),
                lns, null, new DeepPartialSolutionsStrategy(), fp, null, null);
        solver.name = new Object() {}.getClass().getEnclosingMethod().getName();
        return solver;
    ...
    public static I_Solver PIBT_AllAgentSelector(){
        int replanningPeriod = 3;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = null;
        int targetsCapacity = 18;
    ...
    public static I_Solver PrPt_SubSetSelector(){
        int replanningPeriod = 3;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = null;
        int targetsCapacity = 18;
        I_AStarFailPolicy asfpf = new GoASFP(5);
        PrioritisedPlanning_Solver prp = new PrioritisedPlanning_Solver(new SingleAgentAStar_Solver(), null, new SumServiceTimes(),
                new RestartsStrategy(RestartsStrategy.reorderingStrategy.randomRestarts, 10000, RestartsStrategy.reorderingStrategy.randomRestarts, null),
                false, null, TransientMAPFSettings.defaultTransientMAPF, RHCRHorizon, null);
    ...
    public static I_Solver PrP_SubSetSelector(){
        int replanningPeriod = 3;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = null;
        int targetsCapacity = 18;
    ...
    public static I_Solver PIBT_h10(){
        int replanningPeriod = 5;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = 10;
        int targetsCapacity = 18;
        I_AStarFailPolicy asfpf = new GoASFP(5);
        PIBT_Solver pibt = new PIBT_Solver(null, RHCRHorizon, false, null);
    ...
    public static I_Solver PIBTt_h10(){
        int replanningPeriod = 5;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = 10;
        int targetsCapacity = 18;
    ...
    public static I_Solver LaCAM_h10(){
        int replanningPeriod = 5;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = 10;
        int targetsCapacity = 18;
    ...
    public static I_Solver LaCAMt_h10(){
        int replanningPeriod = 5;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = 10;
        int targetsCapacity = 18;
    ...
    public static I_Solver LNS_h10(){
        int replanningPeriod = 5;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = 10;
        int targetsCapacity = 18;
        I_AStarFailPolicy asfpf = new GoASFP(5);
        PrioritisedPlanning_Solver initialSolver = new PrioritisedPlanning_Solver(null, null, null,
        ...
        PrioritisedPlanning_Solver iterationsSolver = new PrioritisedPlanning_Solver(null, null, null,
                new RestartsStrategy(RestartsStrategy.reorderingStrategy.none, 1, RestartsStrategy.reorderingStrategy.none, null),
                null, null, null, RHCRHorizon, null);
    ...
    public static I_Solver LNSt_h10(){
        int replanningPeriod = 5;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = 10;
        int targetsCapacity = 18;
        ...
        PrioritisedPlanning_Solver initialSolver = new PrioritisedPlanning_Solver(null, null, new SumServiceTimes(),
                new RestartsStrategy(RestartsStrategy.reorderingStrategy.none, 1, RestartsStrategy.reorderingStrategy.randomRestarts, null),
                null, null, TransientMAPFSettings.defaultTransientMAPF, RHCRHorizon, null);
        PrioritisedPlanning_Solver iterationsSolver = new PrioritisedPlanning_Solver(null, null, new SumServiceTimes(),
                new RestartsStrategy(RestartsStrategy.reorderingStrategy.none, 1, RestartsStrategy.reorderingStrategy.none, null),
                null, null, TransientMAPFSettings.defaultTransientMAPF, RHCRHorizon, null);
    ...
    public static I_Solver PrP_h10(){
        int replanningPeriod = 5;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = 10;
        int targetsCapacity = 18;
    ...
    public static I_Solver PrPt_h10(){
        int replanningPeriod = 5;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = 10;
        int targetsCapacity = 18;
    ...
    public static I_Solver CBS_h10(){
        int replanningPeriod = 5;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = 10;
        int targetsCapacity = 18;
    ...
    public static I_Solver CBSt_h10(){
        int replanningPeriod = 5;
        I_SingleAgentFailPolicy fp = new StayFailPolicy();
        Integer RHCRHorizon = 10;
        int targetsCapacity = 18;
        I_AStarFailPolicy asfpf = new GoASFP(5);
        CBS_Solver cbs = new CBSBuilder().setRHCR_Horizon(RHCRHorizon).setTransientMAPFSettings(TransientMAPFSettings.defaultTransientMAPF).setCostFunction(new SumServiceTimes()).createCBS_Solver();
        A_Solver solver = new LifelongSimulationSolver(null, new StationaryAgentsSubsetSelector(new PeriodicSelector(replanningPeriod)),
                cbs, null, new DeepPartialSolutionsStrategy(), fp, null, null);
        solver.name = new Object() {}.getClass().getEnclosingMethod().getName();
        return solver;
