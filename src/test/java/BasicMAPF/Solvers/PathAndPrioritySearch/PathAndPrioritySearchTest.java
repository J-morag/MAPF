...
class PathAndPrioritySearchTest {
    ...
    // todo - merge various tests that use the same solver so we can reduce runtime. make it more of a table comparison rather than individual tests of pairs.
    ...
    void comparativeTestNaivePaPSUnifiedOpenVsPaPS(){
        ...
        TestUtils.comparativeTest(baselineSolver, nameBaseline, true, true, competitorSolver,
                nameExperimental, true, true, new int[]{5}, 5 * Config.TESTS_SCOPE, 0);
    }
    ...
    void comparativeTestDuplicateDetection(){
        ...
        TestUtils.comparativeTest(baselineSolver, nameBaseline, true, true, competitorSolver,
                nameExperimental, true, true, new int[]{5}, 5 * Config.TESTS_SCOPE, 1);
    }
