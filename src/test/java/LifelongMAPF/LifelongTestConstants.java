...
public class LifelongTestConstants {
    ...
    public static final LifelongAgent agent00to10 = new LifelongAgent(new Agent(5, coor00, coor10), new I_Coordinate[]{coor00, coor04, coor33, coor00, coor43, coor04, coor54, coor10});
    public static final LifelongAgent agent10to00 = new LifelongAgent(new Agent(6, coor10, coor00), new I_Coordinate[]{coor10, coor53, coor35, coor00, coor05, coor54, coor10, coor00});
    public static final LifelongAgent agent04to00 = new LifelongAgent(new Agent(7, coor04, coor00), new I_Coordinate[]{coor04, coor00, coor53, coor32, coor14, coor00, coor10, coor00});
    public static final LifelongAgent agent33to35 = new LifelongAgent(new Agent(8, coor33, coor35), new I_Coordinate[]{coor33, coor35, coor53, coor15, coor43, coor04, coor00, coor35});
    public static final LifelongAgent agent34to32 = new LifelongAgent(new Agent(9, coor34, coor32), new I_Coordinate[]{coor34, coor04, coor35, coor00, coor54, coor12, coor15, coor32});
    public static final LifelongAgent agent43to14 = new LifelongAgent(new Agent(10, coor43, coor14), new I_Coordinate[]{coor43, coor04, coor12, coor00, coor54,  coor35, coor15, coor14});
    public static final LifelongAgent agent34to43 = new LifelongAgent(new Agent(11, coor34, coor43), new I_Coordinate[]{coor34, coor15, coor35, coor54, coor04, coor00, coor12, coor43});
